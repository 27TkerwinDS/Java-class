...
public class App {
    public static void main(String[] args) throws Exception {
        ...
        int num = in.nextInt();
        //had in.next, didn't declare what type of input. changed to in.nextInt();
        ...
        //if statment wrong direction
        // added else statment to add option for discount if veriable does not fit any of the tequirments
